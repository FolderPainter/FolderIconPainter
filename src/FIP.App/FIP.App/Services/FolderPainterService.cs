...
{
    public class FolderPainterService : IFolderPainterService
    {
        public string SettingIcon(string dir, string icoPath, string folderType = "Generic")
        {
            var res = "done.";
        ...
        public string DeleteIcon(string dir)
        {
            try
            {
                // desktop.ini
